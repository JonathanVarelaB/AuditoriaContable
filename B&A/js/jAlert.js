...
;(function($) {
	...
	$.fn.jAlert = function(options) {
		...
		if( alert.type == 'confirm' )
		{
			...
			alert.btns = [
				{ 'text': alert.confirmBtnText, 'theme': 'blue', 'class': 'confirmBtn', 'closeAlert': true, 'onClick': alert.onConfirm },
	...
	$.fn.jAlert.defaults = {
		...
		'confirmQuestion': 'Está a punto de perder información que ha digitado y no ha guardado. <br> ¿Está seguro de que quiere continuar?',
		'confirmBtnText': 'Sí',
		'denyBtnText': 'No',
